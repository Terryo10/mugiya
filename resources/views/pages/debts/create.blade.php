        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body">
                    <div class="card-body">
                        <form method="post" action="/debt_store/{{$stock->id}}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="amount_paid" id="input-price" class="form-control form-control-alternative{{ $errors->has('amount_paid') ? ' is-invalid' : '' }}" value="" required>
